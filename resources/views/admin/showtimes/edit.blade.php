<x-layouts.admin title="Edit Jadwal">
<div class="max-w-2xl">
    ...
    <div class="bg-[#16162a] rounded-xl border border-white/10">
        <div class="p-6 border-b border-white/10">
            <h2 class="text-lg font-semibold text-white">Edit Jadwal</h2>
        </div>
        ...
        <form action="#" method="POST" class="p-6 space-y-6">
            <div>
                ...
                <select name="movie_id" required class="w-full px-4 py-2.5 bg-[#0f0f1a] border border-white/10 rounded-lg text-white">
                    ...
                    <option value="1" selected>Avengers: Endgame</option>
            ...
            <div>
                ...
                <select name="studio_id" required class="w-full px-4 py-2.5 bg-[#0f0f1a] border border-white/10 rounded-lg text-white">
                    ...
                    <option value="1" selected>Cinema XXI Gandaria City - Studio 1 (Regular)</option>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" name="show_date" value="2024-12-22" required
                ...
                <div>
                    ...
                    <input type="time" name="show_time" value="14:30" required
                           class="w-full px-4 py-2.5 bg-[#0f0f1a] border border-white/10 rounded-lg text-white">
                </div>
            </div>
