...
<div class="max-w-2xl">
    ...
    <div class="bg-[#16162a] rounded-xl border border-white/10">
        <div class="p-6 border-b border-white/10">
            <h2 class="text-lg font-semibold text-white">Tambah Studio Baru</h2>
        </div>
        ...
        <form action="#" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name" required placeholder="Studio 1"
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="seats_per_row" value="12" required min="1"
                           class="w-full px-4 py-2.5 bg-[#0f0f1a] border border-white/10 rounded-lg text-white">
                </div>
            </div>
