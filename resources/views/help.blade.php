            ...
            <div class="space-y-4" x-data="{ activeIndex: null }">
                        ...
                        <div class="px-6 pb-6 pt-0 ml-14">
                            <div class="space-y-3">
                                ...
                                <div class="flex items-start gap-3 p-3 bg-[#0f0f1a]/80 rounded-xl border border-white/5">
                                    ...
                                    <p class="text-gray-300 text-sm">Transfer ke rekening bank yang tersedia</p>
                                </div>
                                <div class="flex items-start gap-3 p-3 bg-[#0f0f1a]/80 rounded-xl border border-white/5">
                                    ...
                                    <p class="text-gray-300 text-sm">Upload bukti transfer & tunggu konfirmasi admin</p>
                                </div>
                                <div class="flex items-start gap-3 p-3 bg-[#0f0f1a]/80 rounded-xl border border-white/5">
                                    ...
                                    <p class="text-gray-300 text-sm">E-ticket tersedia di menu "Tiket Saya" setelah konfirmasi</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="bg-[#0f0f1a]/80 rounded-xl p-4 border border-white/5 hover:border-blue-500/30 transition-colors text-center">
                                    <div class="w-12 h-12 rounded-xl bg-blue-600/20 flex items-center justify-center mx-auto mb-3">
                                        <span class="text-blue-400 font-bold text-sm">BCA</span>
                                    </div>
                                    <span class="text-sm font-medium text-white">Bank BCA</span>
                                </div>
                                <div class="bg-[#0f0f1a]/80 rounded-xl p-4 border border-white/5 hover:border-yellow-500/30 transition-colors text-center">
                                    ...
                                    <span class="text-sm font-medium text-white">Bank Mandiri</span>
                                </div>
                                <div class="bg-[#0f0f1a]/80 rounded-xl p-4 border border-white/5 hover:border-orange-500/30 transition-colors text-center">
                                    <div class="w-12 h-12 rounded-xl bg-orange-500/20 flex items-center justify-center mx-auto mb-3">
                                        <span class="text-orange-400 font-bold text-sm">BNI</span>
                                    </div>
                                    <span class="text-sm font-medium text-white">Bank BNI</span>
                                </div>
                            </div>
                            <p class="text-xs text-gray-500 text-center mt-3">Transfer bank adalah satu-satunya metode pembayaran yang tersedia</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group bg-gradient-to-br from-[#1e1e35] to-[#16162a] rounded-2xl border border-white/10 overflow-hidden hover:border-[#e50914]/30 transition-all duration-300">
                    ...
                    <div x-show="activeIndex === 4" x-collapse>
                        <div class="px-6 pb-6 pt-0 ml-14">
                            <div class="bg-gradient-to-br from-[#e50914]/10 to-orange-500/10 rounded-xl p-5 border border-[#e50914]/20">
                                <div class="flex items-center justify-center gap-4">
                                    <div class="w-16 h-16 rounded-full bg-[#e50914]/20 flex items-center justify-center">
                                        <svg class="w-8 h-8 text-[#e50914]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-4xl font-bold bg-gradient-to-r from-[#e50914] to-orange-500 bg-clip-text text-transparent">10 Menit</div>
                                        <div class="text-sm text-gray-400 mt-1">Batas waktu pembayaran</div>
                                    </div>
                                </div>
                                <p class="text-center text-gray-400 text-sm mt-4">Selesaikan pembayaran dalam waktu 10 menit setelah memilih kursi, atau pesanan akan otomatis dibatalkan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="px-6 pb-6 pt-0 ml-14">
                            <div class="flex items-center gap-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl p-4 border border-cyan-500/20">
                                <div class="w-14 h-14 bg-white rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                                    <svg class="w-8 h-8 text-[#0f0f1a]" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M3 11h2v2H3v-2zm0-4h2v2H3V7zm0 8h2v2H3v-2zm4-4h2v2H7v-2zm0-4h2v2H7V7zm0 8h2v2H7v-2zm4-4h2v2h-2v-2zm0-4h2v2h-2V7zm0 8h2v2h-2v-2zm4-4h2v2h-2v-2zm0-4h2v2h-2V7zm0 8h2v2h-2v-2zm4-4h2v2h-2v-2zm0-4h2v2h-2V7zm0 8h2v2h-2v-2z"/>
                                    </svg>
                                </div>
                                <p class="text-gray-300 text-sm leading-relaxed">
