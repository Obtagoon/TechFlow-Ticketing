...
<section class="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <?php if($nowPlaying->first()): ?>
            <img src="<?php echo e($nowPlaying->first()->backdrop_url); ?>" alt="" class="w-full h-full object-cover opacity-40">
        <?php endif; ?>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <a href="<?php echo e(route('movies.index')); ?>" class="px-8 py-4 bg-gradient-to-r from-[#e50914] to-[#b20710] text-white font-semibold rounded-full hover:opacity-90 transition-all transform hover:scale-105 shadow-lg shadow-red-500/25">
                Lihat Semua Film
            </a>
...
<section id="now-playing" class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('movies.index')); ?>?status=now_playing" class="text-[#e50914] hover:text-[#f5c518] font-medium transition-colors flex items-center gap-2">
                Lihat Semua
        ...
        <?php else: ?>
            <div class="flex gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-[#e50914] scrollbar-track-[#16162a] scroll-smooth snap-x snap-mandatory">
                <?php $__currentLoopData = $nowPlaying; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('movies.show', $movie)); ?>" class="group flex-shrink-0 w-[280px] md:w-[300px] lg:w-[320px] snap-start">
                        <div class="relative aspect-[2/3] rounded-xl overflow-hidden mb-3">
                            ...
                            <?php if($movie->rating > 0): ?>
                                <div class="absolute top-3 right-3 flex items-center gap-1 px-2 py-1 bg-black/60 backdrop-blur-sm rounded-lg">
                                    ...
                                    <span class="text-white text-sm font-medium"><?php echo e(number_format($movie->rating, 1)); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <h3 class="font-semibold text-white group-hover:text-[#e50914] transition-colors line-clamp-1"><?php echo e($movie->title); ?></h3>
                        <p class="text-sm text-gray-400 line-clamp-1"><?php echo e($movie->genre); ?></p>
                    </a>
...
<section class="py-16 bg-[#0a0a12]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('movies.index')); ?>?status=coming_soon" class="text-[#e50914] hover:text-[#f5c518] font-medium transition-colors flex items-center gap-2">
                Lihat Semua
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
        ...
        <?php if($comingSoon->isEmpty()): ?>
            <div class="text-center py-12 text-gray-400">
                <p>Belum ada film yang akan datang</p>
            </div>
        <?php else: ?>
            <div class="flex gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-[#e50914] scrollbar-track-[#16162a] scroll-smooth snap-x snap-mandatory">
                <?php $__currentLoopData = $comingSoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('movies.show', $movie)); ?>" class="group flex-shrink-0 w-[280px] md:w-[300px] lg:w-[320px] snap-start">
                        <div class="relative aspect-[2/3] rounded-xl overflow-hidden mb-3">
                            <img src="<?php echo e($movie->poster_url); ?>" alt="<?php echo e($movie->title); ?>" 
                                 class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            ...
                            <?php if($movie->release_date): ?>
                                <div class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                                    <p class="text-sm text-gray-300">
                                        <?php echo e($movie->release_date->format('d M Y')); ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\PrakWeb2025_A_233040022\tubes\TechFlow-Ticketing\resources\views/welcome.blade.php ENDPATH**/ ?>