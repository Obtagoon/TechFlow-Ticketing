...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Semua Film']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Semua Film']); ?>
<div class="py-8">
        ...
        <div class="bg-[#16162a] rounded-xl p-4 mb-8 border border-white/10">
            <form method="GET" class="flex flex-wrap items-center gap-4">
                ...
                <?php if(request()->hasAny(['search', 'status', 'genre'])): ?>
                    <a href="<?php echo e(route('movies.index')); ?>" class="px-4 py-2.5 text-gray-400 hover:text-white transition-colors">
                        Reset
                    </a>
                <?php endif; ?>
            </form>
        ...
        <?php else: ?>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('movies.show', $movie)); ?>" class="group">
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-400 mt-1">
                            ...
                            <span>•</span>
                            <span class="line-clamp-1"><?php echo e($movie->genre); ?></span>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\PrakWeb2025_A_233040022\tubes\TechFlow-Ticketing\resources\views/movies/index.blade.php ENDPATH**/ ?>