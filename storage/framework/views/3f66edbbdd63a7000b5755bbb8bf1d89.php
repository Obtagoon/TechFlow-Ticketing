...
<head>
    ...
    <title><?php echo e($title); ?> - Admin TechFlow Ticketing</title>
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-[#0a0a12] border-r border-white/10 transform transition-transform duration-300 lg:translate-x-0"
            ...
            <nav class="p-4 space-y-1">
                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('admin.movies.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.movies.*') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.cinemas.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.cinemas.*') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.studios.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.studios.*') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.showtimes.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.showtimes.*') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.bookings.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.bookings.*') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.reports.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors <?php echo e(request()->routeIs('admin.reports.*') ? 'bg-[#e50914] text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-white/5 hover:text-white transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 lg:ml-64">
            ...
            <header class="h-16 bg-[#0a0a12]/80 backdrop-blur-md border-b border-white/10 sticky top-0 z-40">
                <div class="h-full px-4 lg:px-8 flex items-center justify-between">
                    ...
                    <h1 class="text-lg font-semibold text-white"><?php echo e($title); ?></h1>

                    <!-- User Menu -->
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center gap-2 text-sm text-gray-300 hover:text-white">
                            <img src="<?php echo e(auth()->user()->avatar_url); ?>" alt="" class="w-8 h-8 rounded-full">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-modal','data' => ['title' => 'Konfirmasi Hapus','message' => 'Data yang dihapus tidak dapat dikembalikan. Yakin ingin melanjutkan?','confirmText' => 'Ya, Hapus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Konfirmasi Hapus','message' => 'Data yang dihapus tidak dapat dikembalikan. Yakin ingin melanjutkan?','confirmText' => 'Ya, Hapus']); ?>
...
<?php /**PATH D:\laragon\www\PrakWeb2025_A_233040022\tubes\TechFlow-Ticketing\resources\views/components/layouts/admin.blade.php ENDPATH**/ ?>